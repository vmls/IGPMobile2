...
public class Volley {
     ...
     */
    public static RequestQueue newRequestQueue(Context context, HttpStack stack,String cacheDirName) {
    ...
    public static RequestQueue newRequestQueue(Context context, String cacheDirName) {
    	return newRequestQueue(context, null, cacheDirName);
    }
}
